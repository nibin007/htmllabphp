...
if (!preg_match ($pattern2, $pass) ){  
   ...
   $sql = "INSERT INTO regform (name, email, phonenumber,Gender,address) VALUES ('$name', '$email', $phone, '$gender', '$addrss')";
...
?>
 ...
 <tr>
       ...
       <td><input type="password" name="pass1" value="<?php echo $pass1; ?>"></td>
    </tr>
